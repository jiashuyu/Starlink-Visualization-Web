...
class WorldMap extends Component {
    ...
    // every second in real time, show one minute of change for each satellite 
    track = data => {
        // sanity check
        ...
        // for every 1000ms, execute the function
        let timer = setInterval(() => {
            ...
            // for each satellite, draw a point
            data.forEach(sat => {
    ...
    // draw one satellite at a specific time
    drawSat = (sat, pos) => {
        ...
        // get and format the name of the satellite
        const { satname } = sat;
